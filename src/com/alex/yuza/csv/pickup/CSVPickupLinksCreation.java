 ...
 **********************************/
public class CSVPickupLinksCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVPickupLinksCreation(Workbook myWorkbook, String csvFileName, String siteName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.pickuplinks, csvFileName, siteName, newFile, unique);
		}
	...
	public void init() throws Exception
		...
		csvLineList = CSVTools.buildCSVPickupLinksLineList(csvFieldList, myWorkbook);
		}
