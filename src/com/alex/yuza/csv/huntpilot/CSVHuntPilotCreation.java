...
/**********************************
 * Class used to create a CSVFile dedicated to Hunt Pilot injection
 * 
 * @author RATEL Alexandre
 **********************************/
public class CSVHuntPilotCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVHuntPilotCreation(Workbook myWorkbook, String csvFileName, String siteName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.huntpilot, csvFileName, siteName, newFile, unique);
		}
	...
	public void init() throws Exception
		...
		csvLineList = CSVTools.buildCSVHuntPilotLineList(csvFieldList, myWorkbook);
		}
