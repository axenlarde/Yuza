...
/**********************************
 * Class used to create a CSVFile dedicated to analog items injection
 * 
 * @author RATEL Alexandre
 **********************************/
public class CSVAnalogCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVAnalogCreation(Workbook myWorkbook, String csvFileName, String siteName, String collectionFileName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.analogs, csvFileName, siteName, newFile, unique);
	...
	public void init() throws Exception
		...
		try
			...
			csvLineList = CSVTools.buildCSVAnalogLineList(csvFieldList, myWorkbook);
			}
