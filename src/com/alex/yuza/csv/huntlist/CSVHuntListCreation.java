...
/**********************************
 * Class used to create a CSVFile dedicated to Hunt List injection
 * 
 * @author RATEL Alexandre
 **********************************/
public class CSVHuntListCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVHuntListCreation(Workbook myWorkbook, String csvFileName, String siteName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.huntlist, csvFileName, siteName, newFile, unique);
		}
	...
	public void init() throws Exception
		...
		csvLineList = CSVTools.buildCSVHuntListLineList(csvFieldList, myWorkbook);
		}
