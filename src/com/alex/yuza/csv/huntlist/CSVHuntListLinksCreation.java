...
/**********************************
 * Class used to create a CSVFile dedicated to Hunt List Links injection
 * 
 * @author RATEL Alexandre
 **********************************/
public class CSVHuntListLinksCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVHuntListLinksCreation(Workbook myWorkbook, String csvFileName, String siteName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.huntlistlinks, csvFileName, siteName, newFile, unique);
		}
	...
	public void init() throws Exception
		...
		csvLineList = CSVTools.buildCSVHLLinksLineList(csvFieldList, myWorkbook);
		}
