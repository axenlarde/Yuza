...
/**********************************
 * Class used to create a CSVFile dedicated to Line group Links injection
 * 
 * @author RATEL Alexandre
 **********************************/
public class CSVLineGroupLinksCreation extends CSVFileCreation
	{
	/**
	 * Variables
	 */
	 ...
	 * @throws Exception 
	 ***************/
	public CSVLineGroupLinksCreation(Workbook myWorkbook, String csvFileName, String siteName, boolean newFile, boolean unique) throws Exception
		{
		super(myWorkbook, csvType.linegrouplinks, csvFileName, siteName, newFile, unique);
		}
	...
	public void init() throws Exception
		...
		csvLineList = CSVTools.buildCSVLGLinksLineList(csvFieldList, myWorkbook);
		}
