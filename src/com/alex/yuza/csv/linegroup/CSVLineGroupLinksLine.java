 ...
 **********************************/
public class CSVLineGroupLinksLine extends CSVLine
	{
	/**
	 * Variables
	 */
	 ...
	 * Constructor
	 ***************/
	public CSVLineGroupLinksLine(ArrayList<CSVField> myFieldList, int indexLineGroup, int indexUser, boolean firstLine,
			Workbook myWorkbook)
		{
		super(myFieldList, indexLineGroup, myWorkbook);
